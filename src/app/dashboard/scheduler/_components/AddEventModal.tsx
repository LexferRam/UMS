...
import { Alert, DialogActions, IconButton, Paper, PaperProps } from "@mui/material"
...
export default function AddEventModal({ onEventAdded, open, setOpen, recoverEvent, rowData, refecthFns }: any) {
    ...
    return (
        <>
            ...
            >
                <DialogTitle style={{ cursor: 'move' }} id="draggable-dialog-title">Nuevo Evento</DialogTitle>
                <IconButton
                    aria-label="close"
