...
const DashboardTabs: FC<{ userInfo: any }> = ({ userInfo }) => {
    ...
    const TABLE_HEAD_EVENTS = ["Título de evento", "Nombre paciente", "Estatus paciente", "Acciones"];
            ...
            <div className="flex items-start">
                <div className="container max-w-6xl px-5 mx-auto my-4">
                    <div className="grid gap-7 sm:grid-cols-2 lg:grid-cols-4">
                        ...
                        <div onClick={() => setSelectedCard('patients')} className="p-5 bg-white rounded shadow-lg hover:shadow-2xl cursor-pointer">
                            <div className="flex items-center space-x-4">
                                ...
                                <div>
                                    <div className="text-gray-400">Mis Pacientes</div>
                                    <div className="text-2xl font-bold text-gray-900">{userInfo[0]?.asignedPatients.length}</div>
                                </div>
                            </div>
                        </div>

                        <div onClick={() => setSelectedCard('events')} className="p-5 bg-white rounded shadow-lg hover:shadow-2xl cursor-pointer">
                            <div className="flex items-center space-x-4">
                                <div>
                                ...
                                <div>
                                    <div className="text-gray-400">Eventos para hoy</div>
                                    <div className="text-2xl font-bold text-gray-900">{eventForToday(userInfo[0]?.events).length}</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="p-5 bg-white rounded shadow-lg hover:shadow-2xl">
                            <div className="flex items-center space-x-4">
                                ...
                                <div>
                                    <div className="text-gray-400">Mis reportes</div>
                        ...
                        <div onClick={() => setSelectedCard('patients')} className="p-5 bg-white rounded shadow-lg hover:shadow-2xl cursor-pointer">
                            <div className="flex items-center space-x-4">
                                ...
                                <div>
                                    <div className="text-gray-400">Reporte faltantes</div>
                                    <div className="text-2xl font-bold text-gray-900">{eventForToday(userInfo[0]?.events).length}</div>
                                </div>
                            </div>
                        </div>
